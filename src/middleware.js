...
export async function middleware(request) {
    ...
    const protectedRoutes = [`/${lng}/account/dashboard`, `/${lng}/account/notification`, `/${lng}/account/wallet`, `/${lng}/account/bank-details`,  `/${lng}/account/point`, `/${lng}/account/refund`, `/${lng}/account/order`, `/${lng}/account/addresses`, `/${lng}/wishlist`, `/${lng}/compare`, `/${lng}/checkout`]
